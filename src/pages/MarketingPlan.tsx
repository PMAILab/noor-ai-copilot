...
export default function MarketingPlan() {
  return (
    <div className="flex flex-col items-center justify-center p-32 text-center max-w-2xl mx-auto">
      ...
      <h1 className="font-h1 text-[40px] text-on-surface mb-4">Marketing Plan</h1>
      <p className="font-body-lg text-on-surface-variant text-[18px]">
        This feature is under development. Soon, you will be able to generate comprehensive month-long marketing strategies using AI.
      </p>
    </div>
  );
}
